<?php
    ...
    $tong_count = $row_lienhe['numb']+$row_bookingtv["numb"];
                ...
                <li class="ddnew" style="position:relative">
                    ...
                    <div class="popover-notifications" style="top: 35px;right: 0px;transform-origin: 60px top;">
                        <div>
                            ...
                            <?php if($BOOKING==true){?>
                            <div>
                                <a href="index.html?com=booking&act=man&type=client" title="" ><span>Đăng ký</span> <span>(<?=($row_bookingtv['numb']==0) ? 0 : $row_bookingtv['numb']?>)</span> 
                                    </a>
                            </div>
                            <?php }?>
                        </div>
