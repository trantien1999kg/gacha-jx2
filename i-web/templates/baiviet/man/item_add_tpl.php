                ...
                <div class="widget mtop0">
                    ...
                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required"
                                data-validation-error-msg="Thông tin không được để trống"
                                name="data[thongtin_<?=$k?>]" title="Nhập thông tin" id="thongtin_<?=$k?>" class="tipS"
                                value="<?=@$item['thongtin_'.$k]?>" />
                    ...
                    <div class="formRow">
                        ...
                        <label>Tỉ lệ thắng (%)</label>

                        <div class="formRight">

                            <input type="text" name="data[phantram]" title="Nhập tỉ lệ thắng" id="phantram" class="tipS"
                                value="<?=@$item['phantram']?>" />
                ...
                <div class="widget mtop0">
                        ...
                        <div class="formRight">
                            ...
                            <label class="stardust-checkbox checker flex-checkbox">
                                ...
                                <input class="stardust-checkbox__input"
                                    <?php if(in_array($value['id'],$arr)) echo 'checked';?> name="id_thuonghieu[]"
                                    id="check<?=$key?>" type="checkbox" value="<?=$value['id']?>" style="display:none">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" name="data[xuatxu]" title="Nhập mã sản phẩm" id="xuatxu" class="tipS"
                                value="<?=@$item['xuatxu']?>" />
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" name="data[rating]" title="Nhập số sao cẩn đánh giá" id="rating"
                                class="tipS conso" value="<?=@$item['rating']?>"
                                style="font-size: 12px;padding: 7px 6px;background: white;border: 1px solid #DDD;width: 100%;font-family: Arial, Helvetica, sans-serif;color: #656565;box-sizing: border-box;" />
