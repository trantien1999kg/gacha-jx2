...
$(document).ready(function() {
    ...
    $('#search_btn').click(function(event) {
        ...
        let ngayquay = $('#ngayquay').val();

        let phanthuong = $('#prize').val();

        window.location.href = 'index.php?com=baiviet&act=man&date=' + ngayquay + '&prize=' +
            phanthuong + '&type=thong-ke&page=' + <?=$_GET["page"]?>
...
<div class="box-dashboards">
    ...
    $result_prize=$db->rawQuery("select id, ten_$lang as ten from #_baiviet where hienthi=1 and type='phan-thuong'");
    ...
    <form name="f" id="f" method="post">
        ...
        <div class="oneOne" style="margin-top:0;">
            <div style="float:left;">
                <input type="text" name="ngayquay" id="ngayquay" class="input_search date-picker"
                    placeholder="Ngày quay thưởng" value="<?=$_GET['date']?>" />
                <select name="prize" class="main_select" id="prize">
                    <option value="">Chọn phần thưởng</option>
                    <?Php foreach($result_prize as $k => $v){?>
                    <option value="<?=$v['id']?>" <?php if($_GET['prize']==$v['id']) echo 'selected'; ?>><?=$v['ten']?>
                    </option>
                    <?php } ?>
                </select>
        ...
        <div class="oneOne" style="margin-top:0;">
            <p style="color:#f00;font-size:20px;margin-bottom:10px;">Danh sách giải thưởng phải là số chẵn (vd: 4,6,8,10)</p>
            <p style="color:#f00;font-size:20px;">Tổng phần trăm tỉ lệ thắng của tất cả giải thưởng phải = 100%</p>
        </div>
                ...
                <div class="timkiem">
                    ...
                    <select class="main_select" name="data[id_cat]" id="id_cat"
                        ...
                        <option value="<?=$items_cat[$i]['id']?>"
                            <?=($_GET['id_cat']==$items_cat[$i]['id']) ? 'selected':''?>><?=$items_cat[$i]['ten_vi']?>
                        </option>
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td class="sortCol" style="width:200px">

                                <div><?=($_GET["type"]=='thong-ke') ? 'Tên khách hàng' : 'Tiêu Đề'?></div>

                            </td>
                            <?php if($_GET['type']=='phan-thuong'){?>

                            <td class="sortCol" align="center" style="width:90px">
                            ...
                            <td class="sortCol" align="center" style="width:140px">

                                <div>Tên phần thưởng</div>
                            ...
                            <?php } ?>
                            <?php if($_GET["type"]=='thong-ke'){?>
                            <td align="center">Ngày quay thưởng</td>
                            <?php } ?>
                    ...
                    <tbody>
                        ...
                        <?php for($i=0, $count=count($items); $i<$count; $i++){
                            $item__sale=$db->rawQueryOne("select id,ten_$lang as ten, photo,ngaytao from #_baiviet where hienthi=1 and id='".$items[$i]['id_list']."' limit 1");   
                            ?>
                        ...
                        <tr>
                            ...
                            <td align="center" class="title_name_data">
                                ...
                                <img class="img-list" src="<?=_upload_baiviet.$item__sale['photo']?>" alt="" width="70">
                            ...
                            <td class="tb_data_small"><?=date('d/m/Y H:i:s',$items[$i]['ngaytao'])?></td>
                            ...
                            <td style="width:90px" align="center">
                                ...
                                <select name="status" <?php if($items[$i]['id_loai']==0){
                                    ...
                                    }?> data-table="baiviet" data-type="post" data-id="<?=$items[$i]['id']?>"
                                    class="main_select js-update-status">
