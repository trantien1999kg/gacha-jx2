    ...
    class product{
        ...
        public function getMans(){
...

            {
                ...
                $ngayquay_s=strtotime(str_replace('/','-',$_GET['date']).' 00:00');

                $ngayquay_e=strtotime(str_replace('/','-',$_GET['date']).' 23:59');

                $where.=" and ngaytao >= '{$ngayquay_s}' and ngaytao <='{$ngayquay_e}'";
        ...
        public function deleteMan(){
            ...
            global $type,$url_path,$folder,$act;
            ...
            if(isset($_GET['id'])){
                ...
                if($item){
                    ...
                    $this->_d->rawQuery("delete from #_seo where idmuc=? and com=? and type=? limit 1",array($item['id'], $this->_com,$type));
